...
def generic_ai_chat(request: ChatRequest, db: Session = Depends(get_db)):
    try:
        ...
        system_prompt = (
            ...
            "RULE 4 - GENERAL KNOWLEDGE FALLBACK: First, always try to answer based on the LIVE DATA provided. If the information requested is NOT available in the LIVE DATA (e.g., historical facts, general Kumbh Mela information, external queries), you MUST think carefully and use your own general intelligence to provide an accurate and helpful answer.\n"
